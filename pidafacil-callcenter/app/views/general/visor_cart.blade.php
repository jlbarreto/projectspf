...
<html lang="es">
    ...
    <body style="background-image:url(http://ec2-54-236-21-142.compute-1.amazonaws.com/pidafacil-callcenter/public/images/background.jpg); background-position: 50% 50%;
        ...
        <script type="text/javascript">
            ...
            document.onreadystatechange = function () {
                if (document.readyState != "complete") {
                    ...
                    imgCentro = "<div style='text-align:center;height:" + alto + "px;'><div  style='color:#000;margin-top:" + heightdivsito + "px; font-size:20px;font-weight:bold'>" + mensaje + "</div><img src='http://images.pf.techmov.co/ajax-loader.gif'></div>";
