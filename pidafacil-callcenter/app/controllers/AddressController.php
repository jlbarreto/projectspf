...
class AddressController extends \BaseController {
	...
	public function create(){
		...
		$addrss = new Address;
		$addrss->user_id		= Input::get('user_id_adress');
		...
		//$addrs = Address::where('user_id', Input::get('user_id_adress'))->get();
		$addrss = Address::where('user_id', Input::get('user_id_adress'))->get();
		...
		$cantAdd = count($direcciones);

        if($cantAdd >= 1){
        	return Response::json(array('direcciones'=>$direcciones));
        }else{
    		$direcciones = 0;
        	return Response::json(array('direcciones'=>$direcciones));
        }
