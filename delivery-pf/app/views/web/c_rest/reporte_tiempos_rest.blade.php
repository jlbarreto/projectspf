...
<div class="table-responsive">
	<h2 style="text-align:center;">Reporte tiempo de ordenes</h2>
		...
		<button id="Btiempo" class="btn btn-primary">Buscar</button>
		<button id="limpiar" class="btn btn-danger">Limpiar</button>
	<br>
	<br>
	<table class="table table-bordered" id="tablaReporteT_rest">
		<thead>
			<tr>
				<th>Orden</th>
				<th>Hora creación</th>
				<th>Llegada a restaurante</th>
				<th>Salida de restaurante</th>
