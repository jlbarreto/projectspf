...
class Webcontent extends \Eloquent {
	...
	public static $reglas = array(
		'header' 		=> 'image|mimes:jpeg|max:500', 
		'logo'			=> 'image|max:200',
		'banner'		=> 'image|mimes:jpeg|max:500',
		'slogan'		=> 'required|max:45',
...
//		'restaurant_id'	=> 'required|exists:res_restaurants,restaurant_id'
    ...
    public static $mensaje = array(
    	'restaurant_id.required' => 'Ha surgido un error , contacte administrador, required',
    	'restaurant_id.integer'  => 'Ha surgido un error , contacte administrador, integuer',
