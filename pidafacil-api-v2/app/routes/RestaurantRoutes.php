...
Route::group(array(), function(){
	...
	// Show menu sections
	Route::post('/sections/{restaurant}', array('uses' => 'RestaurantController@sections'));

	// Show products from menu
	//Route::post('/products', array('uses' => 'RestaurantController@products'));
	Route::post('/products/{secID}', array('uses' => 'RestaurantController@products'));

	// Show address restaurant
	Route::post('/address/{restaurant}', array('uses' => 'RestaurantController@addresses'));
