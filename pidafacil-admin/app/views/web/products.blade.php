...
<div class="container white_content">
	...
	<div class="row">
				...
				<div class="col-sm-6 col-xs-6">
					<div class="singleproduct_image">
						@if($product->image_web != null)
							<img src="{{ URL::to($product->image_web) }}" alt="Imagen de producto">
						@else
							<?php 
							$rest = Restaurant::where('restaurant_id', $product->restaurant_id)->with('landingpage')->first(); ?>
							{{ HTML::image($rest->landingpage->logo, 'No hay imagen') }}
						@endif
					</div>
				</div>
				<div class="col-sm-6 col-xs-6">
		...
		<div class="col-sm-6 col-xs-12">
		<div class="types">
			{{ Form::open(array('url'=>'cart/add','method'=>'post', 'id'=>'frmAddPrd', 'class' => 'create_order', 'role' => 'form', 'data-toggle' => 'validator')) }}
