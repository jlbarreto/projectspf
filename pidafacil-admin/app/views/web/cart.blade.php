				...
				@if(is_array($products))
					<div class="col-md-9 text-left">
						...
						@endforeach
						  ...
						  <tfoot>
						  	<tr>
						  		<td colspan="7" class="text-right"><strong>Total a pagar: $ {{ number_format( $total_order, 2) }}</strong></td>
						  	</tr>
						  </tfoot>
						</table>
						</div>
				...
				@else
					<div class="col-md-3 text-left" style="padding: 0px;">
						<div class="detail gray_content" style="margin-bottom: 1em;">
							<h2>{{ $products }} </h2>
							<h4>El total a pagar es: <strong>$ {{number_format( $total_order, 2) }}</strong></h4>
								<?php Session::put('total_order', $total_order); ?>
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
									<a href="{{ URL::to('cart/checkout') }}" class="btn btn-default btn-lg">Procesar</a>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
