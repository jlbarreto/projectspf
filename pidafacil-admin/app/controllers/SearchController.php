...
class SearchController extends BaseController {
	...
	public function autocomplete(){		
		...
		$data = array();
		$tags = DB::select('select tags.tag_id, tags.tag_name, tipos_tags.tag_type_id from com_tags as tags inner join com_tag_types as tipos_tags  
		...
		$restaurants = DB::select('select restaurante.restaurant_id, restaurante.name, 
						restaurante.slug  from res_restaurants restaurante');
	...
	public function tags($tag){
		$restaurants = DB::select('select restaurants.name , restaurants.address, restaurants.phone, restaurants.slug, tags.tag_name from res_tags restags 
