...
Route::get('/app', array('uses' => 'UserController@enlaceApp'));
...
Route::group(array('prefix'=>'/soporte'), function() {
    Route::get('/', array('uses' => 'UserController@chatCliente'));

    Route::get('/ubicacion_cliente', array('uses' => 'UserController@UbicacionCliente'));
});
...
Route::group(array('before' => 'auth', 'prefix'=>'user'), function(){    
    ...
    Route::get('/address/edit/{id}', array('uses' => 'AddressController@edit'));

    // Get municipalities from states
    Route::post('/address/municipalities', array('uses' => 'AddressController@getMunicipalities'));

    // Get States from country
    Route::post('/address/states', array('uses' => 'AddressController@getStates'));

    // Show zones by municipality
    Route::post('/address/zonesByMunicipality', array('uses' => 'AddressController@getZonesByMunicipality'));
