...
<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 12px; ">
    <div style="background-color: black; text-align: center; padding: 1em 0;">
        <img style=" max-width:400px; max-height: 200px;" src="http://images.pf.techmov.co/pidafacil_logo.png"/>
    </div>
    ...
    @endif
    <p><a href="http://pidafacil.com/user/orders">Orden codigo: {{ $bmail['order_cod'] }}</a></p>
