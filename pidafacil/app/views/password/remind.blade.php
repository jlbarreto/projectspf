  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav">
      <li class="dropdown">
				...
				<li class="divider"></li>
				<li><a href="{{ URL::to('cart') }}">Carrito de Compras</a></li>
			...
			<li><a href="{{ URL::to('cart') }}"><i class="fa fa-shopping-cart fa-lg"></i> Carrito de Compras</a></li>
    </ul>
		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				<div class="types">
					...
					<h1>&iquest;Has olvidado tu contrase&ntilde;a?</h1>
					<label for="email">Ingresa tu correo electr&oacute;nico:</label>
					<form action="{{ action('RemindersController@postRemind') }}" method="POST">
					    <div class="form-group">
					    	<input type="email" name="email" class="form-control">
					    </div>
					    <input type="submit" value="Restablecer la contrase&ntilde;a" class="btn btn-primary">
					</form>
