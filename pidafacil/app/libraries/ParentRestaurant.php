...
class ParentRestaurant{
    ...
    public static function restricciones(){
        ...
        $restricciones = '^((?!order|conditions|payment-method|profile|login|logout|register|cart|promociones|user|restaurant-orders|sections|explorar|tags|search|password|admin|zones|soporte).)*';
